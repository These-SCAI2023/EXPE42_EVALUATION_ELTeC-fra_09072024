...
path_corpora = "../small-ELTeC-fra-2021-2024_REN/AIMARD_RIVIERE/*"
start_char = 16492-80
end_char = 16505+80
modeles = ["lg", "md", "sm"]
# modeles = ["md"]
    ...
    for path_file in glob.glob(path_corpora):
        if "REF" in path_file:
            ...
            for reffile in glob.glob(ref_files):
                ...
                stocker(f"{path_out_ref}_postag_flair.json", sentence.to_tagged_string())
